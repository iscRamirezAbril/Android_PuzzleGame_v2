...
import kotlinx.android.synthetic.main.activity_puzzle3.*
...
class Puzzle3_Activity : AppCompatActivity() {
    companion object {
    ...
    private fun setTileBoardDimensions() {
        val observer = puzzle3_grid_view.viewTreeObserver
        observer.addOnGlobalLayoutListener(object : OnGlobalLayoutListener {
            override fun onGlobalLayout() {
                puzzle3_grid_view.viewTreeObserver.removeOnGlobalLayoutListener(this)

                val displayWidth = puzzle3_grid_view.measuredWidth
                val displayHeight = puzzle3_grid_view.measuredHeight
    ...
    private fun displayTileBoard() {
        ...
        tileListIndexes.forEach { i ->
            ...
            when (i) {
                0 -> tileImage.setBackgroundResource(R.drawable.rompecabezas3_pieza1)
                1 -> tileImage.setBackgroundResource(R.drawable.rompecabezas3_pieza2)
                2 -> tileImage.setBackgroundResource(R.drawable.rompecabezas3_pieza3)
                3 -> tileImage.setBackgroundResource(R.drawable.rompecabezas3_pieza4)
                4 -> tileImage.setBackgroundResource(R.drawable.rompecabezas3_pieza5)
                5 -> tileImage.setBackgroundResource(R.drawable.rompecabezas3_pieza6)
                6 -> tileImage.setBackgroundResource(R.drawable.rompecabezas3_pieza7)
                7 -> tileImage.setBackgroundResource(R.drawable.rompecabezas3_pieza8)
                8 -> tileImage.setBackgroundResource(R.drawable.rompecabezas3_pieza9)
            }

            tileImages.add(tileImage)
        }

        puzzle3_grid_view.adapter = TileImageAdapter(tileImages, boardColumnWidth, boardColumnHeight)
    }
