...
import kotlinx.android.synthetic.main.activity_puzzle4.*
...
class Puzzle4_Activity : AppCompatActivity() {
    companion object {
    ...
    private fun setTileBoardDimensions() {
        val observer = puzzle4_grid_view.viewTreeObserver
        observer.addOnGlobalLayoutListener(object : OnGlobalLayoutListener {
            override fun onGlobalLayout() {
                puzzle4_grid_view.viewTreeObserver.removeOnGlobalLayoutListener(this)

                val displayWidth = puzzle4_grid_view.measuredWidth
                val displayHeight = puzzle4_grid_view.measuredHeight
    ...
    private fun displayTileBoard() {
        ...
        tileListIndexes.forEach { i ->
            ...
            when (i) {
                0 -> tileImage.setBackgroundResource(R.drawable.rompecabezas4_pieza1)
                1 -> tileImage.setBackgroundResource(R.drawable.rompecabezas4_pieza2)
                2 -> tileImage.setBackgroundResource(R.drawable.rompecabezas4_pieza3)
                3 -> tileImage.setBackgroundResource(R.drawable.rompecabezas4_pieza4)
                4 -> tileImage.setBackgroundResource(R.drawable.rompecabezas4_pieza5)
                5 -> tileImage.setBackgroundResource(R.drawable.rompecabezas4_pieza6)
                6 -> tileImage.setBackgroundResource(R.drawable.rompecabezas4_pieza7)
                7 -> tileImage.setBackgroundResource(R.drawable.rompecabezas4_pieza8)
                8 -> tileImage.setBackgroundResource(R.drawable.rompecabezas4_pieza9)
            }

            tileImages.add(tileImage)
        }

        puzzle4_grid_view.adapter = TileImageAdapter(tileImages, boardColumnWidth, boardColumnHeight)
    }
